...
function NavBar() {
	return (
		<header className="sticky top-0 left-0 flex-center w-full gap-5 items-center px-7 py-3 font-bold border-b border-zinc-300 leading-[154.5%] max-md:flex-wrap max-md:px-5 bg-white/60 backdrop-blur-md">
